...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/ddl/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./var/www/ddl/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'pages.index','pages.shop','pages.about','pages.contacts',
'admin.dashboard','profile.edit','profile.update','profile.destroy','register','login','password.request','password.email',
...
'admin.index','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
...
'dashboard','includes.footer','includes.hero','includes.hero2','includes.nav',
'layouts.admin','layouts.app','layouts.guest','layouts.navigation','pages.about',
'pages.contacts','pages.index','pages.shop','profile.edit','profile.partials.delete-user-form',
