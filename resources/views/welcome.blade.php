					...
					<div class="row justify-content-between">
						...
						<div class="col-lg-7">
							<div class="hero-img-wrap">
								<img src="{{asset("ddl/images/couch.png")}}" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-7 mb-5 mb-lg-0">
						<div class="imgs-grid">
							<div class="grid grid-1"><img src="{{asset("ddl/images/img-grid-1.jpg")}}" alt="Untree.co"></div>
											...
											<div class="testimonial-block text-center">
												...
												<div class="author-info">
													<div class="author-pic">
														<img src="{{asset("ddl/images/person-1.png")}}" alt="Maria Jones" class="img-fluid">
													</div>
				...
				<div class="row">
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="#" class="post-thumbnail"><img src="{{asset("ddl/images/post-1.jpg")}}" alt="Image" class="img-fluid"></a>
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="#" class="post-thumbnail"><img src="{{asset("ddl/images/post-2.jpg")}}" alt="Image" class="img-fluid"></a>
							<div class="post-content-entry">
					...
					<div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
						<div class="post-entry">
							<a href="#" class="post-thumbnail"><img src="{{asset("ddl/images/post-3.jpg")}}" alt="Image" class="img-fluid"></a>
							<div class="post-content-entry">
				...
				<div class="row">
					<div class="col-lg-8">
						<div class="subscription-form">
							<h3 class="d-flex align-items-center"><span class="me-1"><img src="{{asset("ddl/images/envelope-outline.svg")}}" alt="Image" class="img-fluid"></span><span>Subscribe to Newsletter</span></h3>
